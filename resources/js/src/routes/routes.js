const routes = [
    ...
    },
    {
        path: "/auth",
        component: () =>
            import("@Components/__pages/__layouts/Authentication.vue"),
        children: [
            {
                path: "login",
                name: "login-page",
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () =>
                    import(
                        "@Components/__pages/__dashboard/master-data/user/Index.vue"
                    ),
                meta: {
                    auth: true,
                    title: "Pengguna",
            ...
            },
            {
                ...
                component: () =>
                    import(
                        "@Components/__pages/__dashboard/report/scheduling/Index.vue"
                    ),
                meta: {
                    auth: true,
